/*
  ...
  - You are about to drop the column `avatarUrl` on the `Hunter` table. All the data in the column will be lost.
...
INSERT INTO "new_Hunter" ("age", "autoMatch", "autoMatchPreferences", "class", "currentLat", "currentLng", "gender", "id", "rank", "rankScore", "userId") SELECT "age", "autoMatch", "autoMatchPreferences", "class", "currentLat", "currentLng", "gender", "id", "rank", "rankScore", "userId" FROM "Hunter";
DROP TABLE "Hunter";
